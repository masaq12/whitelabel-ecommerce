...
<a href="<?php echo e(route('order.history')); ?>" class="btn btn-outline-secondary btn-sm"><i class="bi bi-arrow-left me-1"></i>Back to Orders</a>
</div>
<div class="row g-4">
<div class="col-md-8">
...
<div class="card-body">
<h6 class="fw-bold mb-3"><i class="bi bi-truck me-2"></i>Order Tracking — <code><?php echo e($order->order_number); ?></code></h6>
...
<?php $active = in_array($order->status, array_keys(array_slice($steps,0,array_search($key,array_keys($steps))+1))); ?>
<div class="text-center flex-fill">
<div class="rounded-circle d-inline-flex align-items-center justify-content-center <?php echo e($active?'bg-success text-white':'bg-light text-muted'); ?>" style="width:44px;height:44px;font-size:1.1rem">
<i class="bi bi-<?php echo e($key=='pending'?'receipt':($key=='processing'?'gear':($key=='shipped'?'truck':'house-check'))); ?>"></i>
</div>
<div class="small mt-1 fw-semibold <?php echo e($active?'text-success':''); ?>"><?php echo e($label); ?></div>
</div>
<?php if(!$loop->last): ?><div class="flex-fill d-flex align-items-center" style="margin-top:-20px"><hr class="w-100 <?php echo e($active?'border-success':''); ?>"></div><?php endif; ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<hr>
<div class="d-flex justify-content-between fw-bold fs-5"><span>Total</span><span>$<?php echo e(number_format($order->total_amount,2)); ?></span></div>
</div>
</div>
</div>
<div class="col-md-4">
...
<dt class="col-5">Date</dt><dd class="col-7"><?php echo e($order->created_at->format('M d, Y')); ?></dd>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laravel\whitelabel-ecommerce\resources\views/user/orders/show.blade.php ENDPATH**/ ?>