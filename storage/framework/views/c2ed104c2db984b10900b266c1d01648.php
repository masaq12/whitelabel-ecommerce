...
<head>
    ...
    <title>Admin – <?php echo $__env->yieldContent('title', 'Dashboard'); ?> | <?php echo e($settings->site_name); ?></title>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">
    <style>
        :root { --primary: <?php echo e($settings->primary_color ?? '#007bff'); ?>; }
...
<div class="main-content">
    ...
    <?php $__currentLoopData = ['success','error','warning']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if(session($t)): ?>
            <div class="alert alert-<?php echo e($t==='error'?'danger':$t); ?> alert-dismissible fade show">
...
<?php /**PATH E:\laravel\whitelabel-ecommerce\resources\views/layouts/admin.blade.php ENDPATH**/ ?>